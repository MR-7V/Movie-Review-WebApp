      ...
      <div className="MovieDetails">
            {movieDetails.map((movie) => {
                ...
                <div>
                    ...
                    style={{ backgroundImage: `url(${movie.bgPoster})`,backgroundRepeat:"round !important"}}
                    >
                    <div className="banner">
                        ...
                        <h1 className="movieTitleD"> {(movie.title).toUpperCase} </h1>
          ...
          <Button variant="primary">Understood</Button>
            ...
            <div>
            {
                reviews ?  reviews.map((Movie) =>{
                    return (
                        // <div>
                        // <h2>{Movie.userInfo.name}</h2>
                        // <h2>{}</h2>
                        // <h1>{Movie.review}</h1>
                        // <h3>{Movie.postedAt}</h3>
                        // </div>
                        <Review name={Movie.userInfo.name} review={Movie.review} date={Movie.postedAt} rating={Movie.rating} />
                    )
                }):"No reviews found"
            }
            </div>
